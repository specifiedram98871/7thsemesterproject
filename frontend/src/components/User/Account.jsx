                ...
                <div className="flex flex-col gap-12 m-4 sm:mx-8 sm:my-6">
                  ...
                  <div className="flex flex-col gap-5 items-start">
                    <span className="font-medium text-lg">
                      ...
                      <Link
                        to="/account/update"
                        className="text-sm text-primary-green font-medium ml-8 cursor-pointer"
                      >
                        Edit
                      </Link>
                    </span>
                  ...
                  <div className="flex flex-col gap-5 items-start">
                    <span className="font-medium text-lg">
                      ...
                      <Link
                        to="/account/update"
                        className="text-sm text-primary-green font-medium ml-3 sm:ml-8 cursor-pointer"
                      >
                        Edit
                      </Link>
                      <Link
                        to="/password/update"
                        className="text-sm text-primary-green font-medium ml-3 sm:ml-8"
                      >
                        Change Password
                      </Link>
                    </span>
                  ...
                  <div className="flex flex-col gap-4 mt-4">
                    ...
                    <h4 className="text-sm font-medium">
                      When will my ShopEase account be updated with the new
                    ...
                    <h4 className="text-sm font-medium">
                      What happens to my existing ShopEase account when I update
                    ...
                    <p className="text-sm">
                      ShopEase has a 'single sign-on' policy. Any changes will
