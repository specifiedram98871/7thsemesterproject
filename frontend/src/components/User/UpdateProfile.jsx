...
const UpdateProfile = () => {
    ...
    return (
        <>
            <MetaData title="Update Profile | ShopEase" />
                    ...
                    <div className="flex-1 overflow-hidden">
                        ...
                        >
                            <div className="flex flex-col gap-4 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-primary-buttonGreen shadow rounded-sm font-medium hover:shadow-lg">Update</button>
