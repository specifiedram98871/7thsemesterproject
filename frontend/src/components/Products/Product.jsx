    ...
    return (
        <div className="flex flex-col items-start gap-2 px-4 py-6 relative hover:shadow-lg rounded-sm">
            ...
            <Link to={`/product/${_id}`} className="flex flex-col items-center text-center group">
                ...
                <h2 className="text-sm mt-4 group-hover:text-primary-green text-left">{name.length > 85 ? `${name.substring(0, 85)}...` : name}</h2>
            </Link>
            {/* <!-- image & product title --> */}
            ...
            <div className="flex flex-col gap-2 items-start">
                ...
                <div className="flex items-center gap-1.5 text-md font-medium">
                    ...
                    <span className="text-gray-500 line-through text-xs">Rs.{cuttedPrice.toLocaleString()}</span>
