...
const MainData = () => {
    ...
    return (
        <>
            <MetaData title="Admin Dashboard | ShopEase" />
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-2 sm:gap-6">
                <div className="flex flex-col bg-purple-600 text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
                    ...
                    <h2 className="text-2xl font-bold">Rs.{totalAmount?.toLocaleString()}</h2>
                </div>
                ...
                <div className="flex flex-col bg-lGreen-500 text-white gap-2 rounded-xl shadow-lg hover:shadow-xl p-6">
