...
const UpdateUser = () => {
    ...
    return (
        <>
            <MetaData title="Admin: Update User | ShopEase" />
                    ...
                    <div className="flex flex-col bg-white shadow-lg rounded-lg mx-auto w-lg max-w-xl">
                        ...
                        >
                            <div className="flex flex-col gap-3 items-start">
                                ...
                                <button type="submit" className="text-white py-3 w-full bg-primary-buttonGreen shadow hover:shadow-lg rounded-sm font-medium">Update</button>
