...
export const getSimilarProducts = (category) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACK_URL}/api/v1/products?category=${category}`,
...
export const getProductDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACK_URL}/api/v1/product/${id}`,
      { withCredentials: true } // Allow cookies
    );
...
export const newReview = (reviewData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_BACK_URL}/api/v1/review`,
      reviewData,
      config
    );
...
export const getSliderProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACK_URL}/api/v1/products/all`,
      { withCredentials: true } // Allow cookies
    );
...
export const getAdminProducts = () => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACK_URL}/api/v1/admin/products`,
      { withCredentials: true } // Allow cookies
    );
...
export const createProduct = (productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.post(
      `${process.env.REACT_APP_BACK_URL}/api/v1/admin/product/new`,
      productData,
      config
    );
...
export const updateProduct = (id, productData) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.put(
      `${process.env.REACT_APP_BACK_URL}/api/v1/admin/product/${id}`,
      productData,
      config
    );
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(
      `${process.env.REACT_APP_BACK_URL}/api/v1/admin/reviews?id=${id}`,
      { withCredentials: true } // Allow cookies
    );
...
export const deleteReview = (reviewId, productId) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(
      `${process.env.REACT_APP_BACK_URL}/api/v1/admin/reviews?id=${reviewId}&productId=${productId}`,
      { withCredentials: true } // Allow cookies
    );
